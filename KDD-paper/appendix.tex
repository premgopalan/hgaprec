...
Gaussian, Gamma, Poisson, etc.).  This is a large
class of models.

The HPF, with the $z_{ui}$ variables described in \mysec{inference},
...
latent variables and the mean-field family sets all
