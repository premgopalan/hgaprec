...
-- or, they consider zero observations as a hack to learn a balanced
user profile.

Poisson factorization avoids these problems with missing data using a
natural assumption. It captures real consumption data, specifically
