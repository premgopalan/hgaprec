...
without the need for ad hoc modifications. The key feature that
differentiates Poisson factorization from traditional methods is its
ability to capture the heterogeneity amongst users and items,
...
stochastic inference to scale to massive data sets and non-parametric
extensions~\cite{Zhou:2012}.
