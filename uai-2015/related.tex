...
Another issue with most Gaussian models is they do not capture the fact that
...
model systematically overestimate the users' budgets, as confirmed in \mysec{eval} using a posterior predictive
