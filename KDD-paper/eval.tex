...
\begin{itemize}
  ...
  \item {\bf PMF}: Probabilistic Matrix Factorization with user and
...
\item {\bf BPF} Bayesian Personalized
  ...
  In particular, we found this prohibitive when applying the BPR
  implementation in the MyMediaLite library for the data sets
  considered here.
\end{itemize}
...
recall over PMF, indicated in \myfig{recall_by_M}. A relatively high
fraction of items recommended by HPF are found to be relevant, and
many relevant items are recommended.
...
recommendations for more active users, and that HPF outperforms PMF on
