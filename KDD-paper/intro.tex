...
components in \myfig{netflix-illustration} (left) illustrate the top items for specific
attribute dimensions and the plot in \myfig{netflix-illustration} (middle) illustrates the
...
(We used one such method in the study of \mysec{eval}.)  Poisson
...
Netflix data set (as we did in \myfig{netflix-illustration}) without appealing to
