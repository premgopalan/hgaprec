...
\mysec{eval}, however, there are significant quantitative advantages
...
Poisson factorization model, including its statistical properties
and methods for scalable inference on large data sets.
