...
# ../../scripts/run.pl -dataset netflixmsr  -nmf &
# ../../scripts/run.pl -dataset nyt  -nmf &
# ../../scripts/run.pl -dataset mendeley  -nmf &
# ../../scripts/run.pl -dataset echonest  -nmf &

# ../../scripts/run.pl -dataset movielens -lda &
# ../../scripts/run.pl -dataset netflixmsr  -lda &
# ../../scripts/run.pl -dataset netflix  -lda &
# ../../scripts/run.pl -dataset nyt  -lda &
# ../../scripts/run.pl -dataset mendeley  -lda &
# ../../scripts/run.pl -dataset echonest  -lda &

# ../../scripts/run.pl -dataset movielens -gen -bias -hier &
# ../../scripts/run.pl -dataset netflix -gen -bias -hier &
# ../../scripts/run.pl -dataset nyt -gen -bias -hier &
# ../../scripts/run.pl -dataset mendeley -gen -bias -hier &
# ../../scripts/run.pl -dataset echonest -gen -bias -hier &

# ../../scripts/run.pl -dataset movielens -ldaprec &
# ../../scripts/run.pl -dataset netflix -ldaprec &
# ../../scripts/run.pl -dataset nyt -ldaprec &
# ../../scripts/run.pl -dataset mendeley -ldaprec &
# ../../scripts/run.pl -dataset echonest -ldaprec &
