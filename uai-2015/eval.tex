...
attributes on the New York Times data set in the
appendix.\footnote{Our source code is available
  from\\ \url{https://github.com/premgopalan/hgaprec}}
...
%% superior performance and computational efficiency of HPF.  
...
\begin{itemize}
  ...
  \item {\bf MF}: Probabilistic Matrix Factorization with user and
    ...
    Matrix Factorization~\cite{Salakhutdinov:2008a}. We selected
    hyperparameters using grid search with a small validation set.
