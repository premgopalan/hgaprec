...
\caption{Predictive performance on data sets. The top and bottom plots
  ...
  recommendations, respectively. While competiting method performance varies
...
users. We find that HPF and BPF significantly outperform competing
methods for generating high quality recommendations for users
listening to music, watching movies, and reading scientific and
newspaper articles.

We first discuss details of each data set and of competing
...
comparison to competing methods. We conclude with an exploratory
...
\begin{itemize}
  ...
  \item {\bf MF (i.e., PMF)}: Probabilistic Matrix Factorization with
...
the BPF and HPF settings described in \mysec{inference} across all
data sets.
