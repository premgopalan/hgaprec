...
governing user and item weights. The prior on $\lambda_u$ captures the
...
$\lambda_u$ for each user, and the rate parameter $\eta_i$ for each
...
\lambda, \eta \g y)$ embeds users and items in a latent space of
